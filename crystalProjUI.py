...
class Ui_CrystalProj(object):
    def setupUi(self, CrystalProj):
        ...
        self.marker_entry = QtGui.QLineEdit(self.groupBox_4)
        self.marker_entry.setObjectName(_fromUtf8("marker_entry"))
        self.gridLayout_4.addWidget(self.marker_entry, 2, 1, 1, 1)
    ...
    def retranslateUi(self, CrystalProj):
        ...
        self.labels_box.setText(_translate("CrystalProj", "Labels", None))
        self.atoms_box.setText(_translate("CrystalProj", "Atoms", None))
